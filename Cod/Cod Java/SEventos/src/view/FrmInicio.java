...
public class FrmInicio extends JFrame implements ActionListener {
	...
	public FrmInicio() {
		...
		// Criando posições "âncora" na tela, Y é a distância do topo, x, x1, x2... são a distância da esquerda e 
		// locais de colunas
		...
		// largura botão = 140
		btnCli = criarButton("Login", centerX - 150, y);
		btnOrg = criarButton("SignUp", centerX + 10, y);
