...
public class AppEventos {
    ...
    public static JFrame abreEvento(JFrame janelaAtual, Evento ev) {
        janelaAtual.setVisible(false);
    ...
    public static JFrame abreEditEvento(JFrame janelaAtual, Evento ev) {
        janelaAtual.setVisible(false);
    	return new FrmEditarEvento(ev);
    }
    public static JFrame abreEditLocal(JFrame janelaAtual, LocalDeEvento loc) {
        janelaAtual.setVisible(false);
